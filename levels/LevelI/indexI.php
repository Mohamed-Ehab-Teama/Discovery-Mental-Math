...
<div class="container text-center mt-5">
    <a href="#">
        <button style="width: 40%; font-size: 2rem;" class="btn btn-warning"> Test 25 </button>
    </a>
</div>
<div class="container text-center mt-5">
    <a href="#">
        <button style="width: 40%; font-size: 2rem;" class="btn btn-warning"> Test 26 </button>
    </a>
</div>
<div class="container text-center mt-5">
    <a href="#">
        <button style="width: 40%; font-size: 2rem;" class="btn btn-warning"> Test 27 </button>
    </a>
</div>
