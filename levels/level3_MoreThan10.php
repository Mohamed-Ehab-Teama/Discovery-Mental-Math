...
<body>
    ...
    <div class="container text-center mt-5">
        <a href="./LevelG/indexG.php">
            <button style="width: 40%; font-size: 2rem;" class="btn btn-warning"> LEVEL G </button>
        </a>
    </div>
    <div class="container text-center mt-5">
        <a href="./LevelH/indexH.php">
            <button style="width: 40%; font-size: 2rem;" class="btn btn-warning"> LEVEL H </button>
        </a>
    </div>
    <div class="container text-center mt-5">
        <a href="./LevelI/indexI.php">
            <button style="width: 40%; font-size: 2rem;" class="btn btn-warning"> LEVEL i </button>
        </a>
    </div>
